...
from data.Dataset_realrain import Dataset_RealRain
...
def main():
    ...
    util.setup_logger('base', opt['path']['log'], 'test_realrain', 
    ...
    test_dataset = Dataset_RealRain(opt['datasets']['test_realrain'])
