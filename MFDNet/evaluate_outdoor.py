...
def main():
    parser = argparse.ArgumentParser(description='Evaluate MFDNet on Outdoor')
    parser.add_argument('--result_dir', default='./results/MFDNet/Outdoor', type=str, help='Directory of generated images')
    parser.add_argument('--gt_dir', default='d:/Deraining/RLP/rlp/data/Outdoor', type=str, help='Directory of GT images')
    ...
    csv_path = os.path.join(args.csv_dir, f'MFDNet_Outdoor_results_{timestamp}.csv')
