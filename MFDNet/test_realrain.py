...
def main():
    parser = argparse.ArgumentParser(description='MFDNet Testing on RealRain')
    parser.add_argument('--input_dir', default='d:/Deraining/RLP/rlp/data/RealRain', type=str, help='Directory of test images')
    parser.add_argument('--result_dir', default='./results/MFDNet/RealRain', type=str, help='Directory for results')
    ...
    for variant, variant_dir in variant_dirs.items():
        ...
        test_dataset = DatasetTest(args.input_dir, variant=variant)
