...
def main():
    parser = argparse.ArgumentParser(description='MFDNet Testing on Outdoor')
    parser.add_argument('--input_dir', default='d:/Deraining/RLP/rlp/data/Outdoor', type=str, help='Directory of test images')
    parser.add_argument('--result_dir', default='./results/MFDNet/Outdoor', type=str, help='Directory for results')
    ...
    with torch.no_grad():
        for i, data_test in enumerate(tqdm(test_loader, desc='Testing Outdoor'), 0):
