...
def main():
    parser = argparse.ArgumentParser(description='MFDNet Testing on GTAV-NightRain')
    parser.add_argument('--input_dir', default='d:/Deraining/RLP/rlp/data/GTAV-NightRain', type=str, help='Directory of test images')
    parser.add_argument('--result_dir', default='./results/MFDNet/GTAV', type=str, help='Directory for results')
    ...
    for test_set in ['set1', 'set2', 'set3']:
        ...
        with torch.no_grad():
            for i, data_test in enumerate(tqdm(test_loader, desc=f'Testing GTAV {test_set}'), 0):
                ...
                for batch in range(len(restored)):
                    ...
                    utils.save_img(os.path.join(set_result_dir, filenames[batch] + '.png'), restored_img)
